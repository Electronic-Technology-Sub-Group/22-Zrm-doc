...
代码的质量和一致性是至关重要的。为了确保团队成员能够遵循统一的编码规范，提高代码的可读性和可维护性，可以采用一系列的工具和流程来辅助开发，如果仅仅是口头约定代码规范，那么在开发过程中的心智负担是比较大的。

如下就是如何初始化一个遵循最佳实践的项目，包括代码质量检测、格式化、版本控制钩子以及提交信息规范：
...
一个好的产品是迭代出来的, 正是因为需要迭代, 因此代码有规范, 迭代也会越顺畅。
